...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token='Epmr3lvmaetgxguhY427.MRMd87JLMY8NA0SCe7JEXW.6jf2/VDW39k17NaLz1csg/5brJzwROxATVRMnq01V5E')
cl.loginResult()
ki=ki2=ki3=ki4=ki5=cl

#ki = ASUL.LINE()
#ki.login(qr=True)
#ki.login(token='EoTGyjxChx3KBNbEPZ17.Hxx9HD4DOCVtyi2H4Xw/LW.rcdk6I+Hmf+DL2RskfwInP7JPJTmpVVz6ZYTd9wZQuM')
#ki.loginResult()
...
Bots = [mid]#,ki2mid,ki3mid,ki4mid,ki5mid]
admsa = ""
admin = ""
